      ...
      <div className="bg-white h-full w-full rounded-xl p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-20 pl-10">
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-blue_text mb-1">Donor Name</label>
              <Input value={`${donation.firstName} ${donation.lastName}`} disabled className="w-full text-sm bg-drop_bg rounded-full shadow-xl" />
            </div>

            <div>
              <label className="block text-sm font-medium text-blue_text mb-1">Email</label>
              <Input value={donation.email} disabled className="w-full text-sm bg-drop_bg rounded-full shadow-xl" />
            </div>

            <div>
              <label className="block text-sm font-medium text-blue_text mb-1">Pickup Location</label>
              <Input value={donation.user_location} disabled className="w-full text-sm bg-drop_bg rounded-full shadow-xl" />
            </div>

            <div>
              <label className="block text-sm font-medium text-blue_text mb-1">Items Donated</label>
              <Input value={donation.items_donated} disabled className="w-full text-sm bg-drop_bg rounded-full shadow-xl" />
            </div>

            <div>
              <label className="block text-sm font-medium text-blue_text mb-1">Drop-off Location</label>
              <Input value={donation.ngo.location} disabled className="w-full text-sm bg-drop_bg rounded-full shadow-xl" />
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-blue_text mb-3">Donation Photos</label>
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2 items-center w-full">
                {accepted ? (
                  <h1 className="text-center font-bold text-xl mt-10">Already Accepted</h1>
                ) : (
                  <>
